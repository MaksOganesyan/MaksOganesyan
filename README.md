<h1 align="center">Привет! Я Макс 👋 | Hi! I'm Max 👋</h1>

<p align="center">
  <b>Fullstack Developer</b> · React · TypeScript · NestJS · Python<br>
...
🇷🇺
Учусь на fullstack-разработчика в Московском Политехе, направление «Веб-технологии». Пишу клиентскую часть на React + TypeScript и backend на NestJS, увлекаюсь оптимизацией производительности и чистой архитектурой. Веду техническую команду образовательного игрового проекта **«Прогулки по Москве»**. Цель — вырасти до senior fullstack-разработчика и технического лидера команды.

🇬🇧
I'm studying fullstack development at Moscow Polytechnic University. I build frontends with React + TypeScript and backends with NestJS, and I care about performance optimisation and clean architecture. I lead the technical team of the educational game project **"Walks around Moscow"**. My goal is to grow into a senior fullstack developer and technical team lead.
...
- **NestJS + PostgreSQL**: модульный REST API, DTO-валидация, guards, централизованная обработка ошибок
- Аутентификация на **JWT (access/refresh)** с ротацией токенов и silent refresh через Axios interceptors
- Unit-тесты на **Vitest** для финансовой логики корзины
